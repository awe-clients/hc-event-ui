...
<section class="py-24 bg-white" id="noticias">
    <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <a href="<?php echo get_post_type_archive_link('post'); ?>" class="group flex items-center gap-4 text-xs font-black uppercase tracking-widest color-5km-text border-b-2 border-zinc-200 pb-2 hover:border-yellow-400 transition-all">
