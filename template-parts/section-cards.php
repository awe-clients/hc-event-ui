                ...
                <div class="p-10 relative z-10">
                    ...
                    <?php if (!$percurso_link_hide) : ?>
                        <div class="grid grid-cols-3 gap-4 mt-16 pt-10 border-t border-zinc-100 text-white text-center font-black italic uppercase">
                            <a href="https://www.mapmyrun.com/routes/view/6754367591" target="_percurso" class="color-5km-text p-4 border"><span class="unskew">5 KM</span></a>
                            <a href="https://www.mapmyrun.com/routes/view/6754365934" target="_percurso" class="color-5km-text p-4 border"><span class="unskew">10 KM</span></a>
                            <a href="https://www.mapmyrun.com/routes/view/6754360153" target="_percurso" class="color-5km-text p-4 border"><span class="unskew">15 KM</span></a>
                        </div>
