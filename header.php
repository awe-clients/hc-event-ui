...
<head>
    ...
    <style>
        :root {
            /* Variáveis Dinâmicas via Customizer */
        ...
        .bg-yellow-brand:hover { background-color: var(--brand-cta-hover); }
...
<body <?php body_class('antialiased text-zinc-900 bg-zinc-50'); ?>>
    ...
    <header>
                ...
                <div class="flex items-center gap-4">
                    ...
                    ?>
                        <a href="<?php echo esc_url($cta_link); ?>"
                            class="bg-yellow-brand text-zinc-900 px-6 py-2 skew-element font-black text-xs uppercase italic transition-colors hidden md:inline-block" target="_blank">
                    ...
                    <button type="button" id="menu-toggle" class="lg:hidden text-zinc-900 p-2 focus:outline-none" aria-label="Abrir Menu">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16M4 6h16M4 18h16"></path>
                        </svg>
                    </button>
                </div>
            </div>
        ...
        <div id="mobile-menu" class="hidden fixed inset-0 z-40 bg-white flex-col pt-24 px-8 lg:hidden">
            <div class="flex flex-col gap-6 text-sm font-black uppercase tracking-widest border-t border-zinc-100 pt-8">
                ...
                <?php if (!$cta_hide) : ?>
                    <a href="<?php echo esc_url($cta_link); ?>" class="bg-yellow-brand text-center py-4 mt-4 font-black uppercase italic text-xs">
